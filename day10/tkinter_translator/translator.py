...
languageV = [l.capitalize() for l in language.values()]
lang1 = language.keys()
...
#translate button
translate = Button(root,text="Translate",font="Roboto 15 bold italic",activebackground="blue",cursor="hand2",bd=5,bg="red",fg='white',command=translate_now)
